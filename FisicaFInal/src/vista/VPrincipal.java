...
public class VPrincipal extends JFrame implements MouseMotionListener, MouseListener, ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		if(arg0.getActionCommand().equals("Limpiar")){
			...
			double carga = Double.parseDouble(vSofia.magnitud.getText()+"E"+vSofia.notacion.getSelectedIndex());
			...
			JOptionPane.showMessageDialog(null, "("+c.getMagnetico().getFuerza()+") N");
